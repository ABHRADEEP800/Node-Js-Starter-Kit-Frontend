...
function ResetPassword() {
    ...
    return (
      <Container>
        <div className="flex justify-center items-center px-4 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-4rem)] py-12">
          <div className="w-full max-w-md bg-white dark:bg-gray-900 p-5 sm:p-8 rounded-2xl shadow-xl border border-red-200 dark:border-red-900/50 text-center animate-fade-in">
  ...
  if (isSuccess) {
    return (
      <Container>
        <div className="flex justify-center items-center px-4 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-4rem)] py-12">
          <div className="w-full max-w-md bg-white dark:bg-gray-900 p-5 sm:p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 text-center animate-fade-in">
  ...
  return (
    <Container>
      <div className="flex justify-center items-center px-4 bg-gray-50 dark:bg-gray-950 min-h-[calc(100vh-4rem)] py-12">
        <div className="w-full max-w-md bg-white dark:bg-gray-900 p-5 sm:p-8 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
